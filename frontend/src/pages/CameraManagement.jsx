...
const CameraManagement = () => {
  const [activeTab, setActiveTab] = useState('cameras'); // 'cameras' or 'videos'
  ...
  const [cameras] = useState([
    { 
      ...
      models: ['Face Detection', 'Face Recognition']
    },
    { 
      id: 2, 
      name: 'Webcam', 
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div style={{
                      ...
                      height: '40px',
                      borderRadius: '10px',
                      background: camera.type === 'rtsp' ? '#e8edf2' : '#dbeafe',
                      display: 'flex',
                      alignItems: 'center',
                ...
                <div style={{ marginTop: '12px' }}>
                  ...
                  <div style={{ fontSize: '12px', color: '#6b7280', marginTop: '4px' }}>
                    <span style={{ fontWeight: '500' }}>Models:</span> {camera.models.join(', ')}
                  </div>
                  <div style={{ fontSize: '12px', color: '#6b7280', marginTop: '4px' }}>
                    <span style={{ fontWeight: '500' }}>URL:</span> {camera.url}
                  </div>
                </div>
